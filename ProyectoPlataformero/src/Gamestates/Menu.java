...
public class Menu extends State implements Statemethods {
	...
	private BufferedImage backgroundImg, backgroundBeachImg;
	...
	public Menu(Game game) {
		...
		loadButtons();
		loadBackground();
		backgroundBeachImg = LoadSave.getSpriteAtlas(LoadSave.MENU_BACKGROUND_IMG);
	}
	...
	public void draw(Graphics g) {
		...
		g.drawImage(backgroundBeachImg, 0, 0, Game.GAME_WIDTH, Game.GAME_HEIGHT, null);
