...
public class Constants {
	...
	public static class UI {
		...
		public static class URMButtons { //Botones URM (Unpause = quitar pausa, Replay = Rejugar, Menu)
	...
	public static class PlayerConstants {
		...
		//Metodo para que devuelva la cantidad de sprites que necesita cada accion
